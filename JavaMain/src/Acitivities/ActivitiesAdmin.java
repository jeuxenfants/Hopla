 ...
 */
public class ActivitiesAdmin extends JFrame {
    ...
    private final String name = "Activities Administration";//Nom donné au groupe qui contient les jeux de l'application en mode admin
    String image = "fond.jpg";
    
    public ActivitiesAdmin() {//contructor pour l'interface du menu activité
    ...
    private class MonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ("retour".equals(s)) {//Comparaison du texte suivant avec le texte du bouton pour déclencher une action si c'est le même texte
                setVisible(false);//Rendre la fentre invisible 
                MenuPrincipalAdmin menu = new MenuPrincipalAdmin();//retour vers le menu Principal 
            }
        }
    }
}
